          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <h1 className="text-4xl font-bold text-foreground sm:text-5xl lg:text-6xl text-balance">
                Reliable Industrial Catering Solutions at Scale
              </h1>
              <p className="text-lg text-muted-foreground sm:text-xl">
                Premium B2B meal supply for factories, companies, and institutions. Trust our expertise in large-scale food preparation with guaranteed quality and hygiene standards.
              </p>
            </div>
          ...
          <div className="relative h-96 overflow-hidden rounded-lg bg-gradient-to-br from-secondary to-accent">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-lg font-semibold text-secondary-foreground">Professional Catering</p>
                <p className="text-sm text-secondary-foreground opacity-75">Large-scale meal preparation</p>
              </div>
            </div>
          </div>
        </div>
